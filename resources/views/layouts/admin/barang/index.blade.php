...
@section('content')
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- Tombol Hapus -->
                                   <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{ $b->id }}">
                                        Hapus
                                    </button>
                                    @endunless
                                </td>
    ...
    {{-- Modal Edit dipisahkan dari tabel --}}
@foreach($barang as $b)
        ...
        <form action="{{ route('barang.destroy', $b->id) }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <p>Apakah Anda yakin ingin menghapus <strong>{{ $b->nama_barang }}</strong>?</p>
                </div>
